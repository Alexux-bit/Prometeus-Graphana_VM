...
sudo apt-get install -y -qq nginx python3-full python3-venv curl wget unzip apt-transport-https software-properties-common gnupg2
...
# Create venv using python3-full (required on Python 3.12+/Debian)
python3 -m venv "${VENV_DIR}"
ok "Virtual environment created at ${VENV_DIR}"

# Install Flask inside the venv — no system pip involved
...
# Run app with the venv interpreter
